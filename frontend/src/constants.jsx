...
export const SECTIONS = [
  ...
  { id: "diagrams", label: "Блок-схемы", description: "Редактор процессов и связей",
    icon: <svg width="20" height="20" viewBox="0 0 20 20" fill="none"><rect x="3" y="3" width="5" height="5" rx="1.2" stroke="currentColor" strokeWidth="1.5"/><rect x="12" y="3" width="5" height="5" rx="1.2" stroke="currentColor" strokeWidth="1.5"/><rect x="7.5" y="12" width="5" height="5" rx="1.2" stroke="currentColor" strokeWidth="1.5"/><path d="M8 5.5h4M14.5 8v2.5L12 13M5.5 8v2.5L8 13" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round"/></svg> },
